...
public class Array {
    public static void main(String[] args) {
        ...
        //String array
        String[] fruits = {"apple", "orange", "mango", "", "banana", "4395"};     // index = 0, 1, 2... // values can be duplicated // number between " " is also a String // can also use boolean etc. array index starts with 0. Apple is 0, orange 1..
